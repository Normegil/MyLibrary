...
public class UTRightSafety {
	...
	private static final Constructor<Right> USER_CONSTRUCTOR = CLASS.getConstructor(User.class, SpecificResource.class, RESTMethod.class);
	...
	public void testUserConstructor_NullUser() throws Exception {
		Validator.validate(USER_CONSTRUCTOR, new Object[]{null, new SpecificResource(MangaREST.class, UUID.randomUUID().toString()), DEFAULT_REST_METHOD});
	}
	...
	public void testUserConstructor_NullRESTMethod() throws Exception {
		Validator.validate(USER_CONSTRUCTOR, USER_GENERATOR.getDefault(false, false), new SpecificResource(MangaREST.class, UUID.randomUUID().toString()), null);
	}
