...
public class UTRight {
	...
	public void testGetUser_UserConstructor() throws Exception {
		...
		Right right = new Right(user, DEFAULT_RESOURCE, DEFAULT_REST_METHOD);
	...
	public void testGetGroup_GroupConstructor() throws Exception {
		...
		assertEquals(group, right.getGroup());
	}

	@Test
	public void testGetGroup_UserConstructor() throws Exception {
		Right right = new Right(USER_GENERATOR.getDefault(false, false), DEFAULT_RESOURCE, DEFAULT_REST_METHOD);
	...
	public void testGetResource() throws Exception {
		Right right = new Right(USER_GENERATOR.getDefault(false, false), DEFAULT_RESOURCE, DEFAULT_REST_METHOD);
		assertEquals(DEFAULT_RESOURCE, right.getResource());
	}
